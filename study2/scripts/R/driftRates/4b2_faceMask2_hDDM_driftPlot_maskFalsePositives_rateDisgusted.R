...
setwd("")
dda <- read.csv('faceMask2_hddm_drift_maskFalsePositives_da_5000.csv', stringsAsFactors = FALSE)
rownames(dda) <- dda[,1]
...
setwd("")
ddf <- read.csv('faceMask2_hddm_drift_maskFalsePositives_df_5000.csv', stringsAsFactors = FALSE)
rownames(ddf) <- ddf[,1]
