# faceMask study 2 hDDM regression output plotting script: re-plot drift rate of false negatives (failing to ID correct emotion)
...
setwd("")
dxx <- read.csv('faceMask2_hddm_drift_maskFalseNegatives_xx_5000.csv', stringsAsFactors = FALSE)
rownames(dxx) <- dxx[,1]
...
setwd("")
daa <- read.csv('faceMask2_hddm_drift_maskFalseNegatives_aa_5000.csv', stringsAsFactors = FALSE)
rownames(daa) <- daa[,1]
...
setwd("")
ddd <- read.csv('faceMask2_hddm_drift_maskFalseNegatives_dd_5000.csv', stringsAsFactors = FALSE)
rownames(ddd) <- ddd[,1]
...
setwd("")
dff <- read.csv('faceMask2_hddm_drift_maskFalseNegatives_ff_5000.csv', stringsAsFactors = FALSE)
rownames(dff) <- dff[,1]
...
setwd("")
dhh <- read.csv('faceMask2_hddm_drift_maskFalseNegatives_hh_5000.csv', stringsAsFactors = FALSE)
rownames(dhh) <- dhh[,1]
...
setwd("")
dss <- read.csv('faceMask2_hddm_drift_maskFalseNegatives_ss_5000.csv', stringsAsFactors = FALSE)
rownames(dss) <- dss[,1]
...
setwd("")
drr <- read.csv('faceMask2_hddm_drift_maskFalseNegatives_rr_5000.csv', stringsAsFactors = FALSE)
rownames(drr) <- drr[,1]
