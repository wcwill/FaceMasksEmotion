...
var consentForm = {
  ...
  timeline: [
    ...
    // {stimulus: "<p>Welcome to this research study conducted by Temple University in collaboration with Ipsos.</p> <p>Please click continue to begin.</p>"},
    {stimulus: "<p>On the next screen, you will see a generic consent form approved by Temple University Institutional Review Board. Your consent to that form is required to participate.</p> <p>Please note that the study will actually only last 30 minutes. Please also disregard any references to students.</p>"},
    // {stimulus: "<p>On the next screen, you will see a generic consent form approved by Temple University Institutional Review Board. Your consent to that form is required to continue participation.</p> <p>Please note that the study will actually only last 30 minutes. Please also disregard any references to students or survey panels other than Ipsos.</p>"},
    ...
    // {stimulus: "<p>Please note that we will also collect basic demographics from you such as age, gender, and ethnicity.</p>"}
  ]
};

// emotion rating task instructions
var emotionRatingInstructs = {
  type: "html-button-response",
  choices: ['Continue'],
  post_trial_gap: 500,
  timeline: [
    {stimulus: "<p>In the first part of the experiment, you will view a series of faces and rate whether or not each face looks angry, disgusted, fearful, happy, sad, or surprised.</p>"+"<p>Sometimes you may be able to see the entire face. Other times you may only be able to see the top or the bottom half of the face.</p>"},
    ...
    {stimulus: "<p>You will complete six rounds of the task and each round will last about 2-3 minutes.</p>"+"<p>Please click continue when you are ready to begin.</p>"}
  ]
};

// person rating task instructions
var personRatingInstructs = {
  type: "html-button-response",
  choices: ['Continue'],
  post_trial_gap: 500,
  timeline: [
    {stimulus: "<p>In the second part of the experiment, you will view a series of faces and rate whether or not each face looks likable, trustworthy, or warm.</p>"+"<p>Sometimes you may be able to see the entire face. Other times you may only be able to see the top half of the face.</p>"},
    {stimulus: "<p>Please imagine that these are the faces of employees providing you service at your local grocery store or restaurant.</p>"+"<p>When you <b>CANNOT</b> see the bottom half of the employee's face, please imagine that they are wearing a facemask.</p>"},
    {stimulus: "<p>Before viewing each face, you will briefly see a + sign display in the center of the screen.</p>"+"<p>You will then see a face appear and you will press one of two keys to indicate whether or not the face is showing a certain quality.</p>"},
    {stimulus: "<p>Please respond as quickly and accurately as possible when you see each face appear.</p>"+"<p>Once the computer has logged your response, the face will disappear and you will see the next + sign display.</p>"},
    {stimulus: "<p>You will complete three rounds of the task and each round will last about 1-2 minutes.</p>"+"<p>Please click continue when you are ready to begin.</p>"}
  ]
};
...
var qInstructs = {
  ...
  "<p>In the third and final part of the experiment, you will respond to a series of questions.</p>"+
  "<p>Please click continue when you are ready to begin.</p>"
};
...
var debrief = {
  ...
  timeline: [
    ...
    // {stimulus: "<p>Click continue to finish the experiment.</p>"+"<p>Please <b>do not</b> close this window.</p>"}
  ]
};
