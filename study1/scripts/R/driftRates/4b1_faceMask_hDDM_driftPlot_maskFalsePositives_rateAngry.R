...
## plot angry drift (disgust faces) by mask
setwd("")
dad <- read.csv('faceMask_hddm_drift_maskFalsePositives_ad_5000.csv', stringsAsFactors = FALSE)
rownames(dad) <- dad[,1]
...
setwd("")
dah <- read.csv('faceMask_hddm_drift_maskFalsePositives_ah_5000.csv', stringsAsFactors = FALSE)
rownames(dah) <- dah[,1]
...
setwd("")
dar <- read.csv('faceMask_hddm_drift_maskFalsePositives_ar_5000.csv', stringsAsFactors = FALSE)
rownames(dar) <- dar[,1]
